...
export default function DataImport() {
  ...
  const bookmarkletCode = `javascript:void(fetch('https://raw.githubusercontent.com/Mahpour4/Map-tracker/claude/map-stores-zones-zcvTK/public/dao-bookmarklet.js').then(r=>r.text()).then(t=>eval(t)))`;
